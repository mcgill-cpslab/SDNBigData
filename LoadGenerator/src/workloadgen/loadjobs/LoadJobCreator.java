...
public class LoadJobCreator extends GenericMRLoadGenerator {
  ...
  private JobConf setupWebSort(int numReducers, String size, String queue, int reqtype, long reqvalue)
          throws Exception {
    ...
    websortJob.set("mapred.job.readflowreqtype", String.valueOf(reqtype));
    websortJob.set("mapred.job.readflowreqvalue", String.valueOf(reqvalue));
  ...
  private JobConf setupSort(int numReducers, String size, String queue, int reqtype, long reqvalue)
          throws Exception {
    ...
    sortJob.set("mapred.job.readflowreqtype", String.valueOf(reqtype));
    sortJob.set("mapred.job.readflowreqvalue", String.valueOf(reqvalue));
  ...
  private JobConf setupGrep(int numReducers, String size, String queue, int reqtype, long reqvalue)
          throws Exception {
    ...
    grepJob.set("mapred.job.readflowreqtype", String.valueOf(reqtype));
    grepJob.set("mapred.job.readflowreqvalue", String.valueOf(reqvalue));
    clearDir(outDir.toString());
    if (MULTIQUEUE == true) {
  ...
  public LoadJob createGrep(int numReducers, int timestamp, String size, String queue,
                            int reqtype, long reqvalue) throws Exception {
    JobConf grepjob = this.setupGrep(numReducers, size, queue, reqtype, reqvalue);
    return new LoadJob(grepjob, timestamp);
  }

  public LoadJob createSort(int numReducers, int timestamp, String size, String queue,
                            int reqtype, long reqvalue) throws Exception {
    JobConf sortjob = this.setupSort(numReducers, size, queue, reqtype, reqvalue);
    return new LoadJob(sortjob, timestamp);
  }

  public LoadJob createWebSort(int numReducers, int timestamp, String size, String queue,
                               int reqtype, long reqvalue) throws Exception {
    JobConf Websortjob = this.setupWebSort(numReducers, size, queue, reqtype, reqvalue);
  ...
  public LoadJob createJob(String jobtype, int numReducers, int timestamp, String inputSize,
                           String QueueName, int jobid, int reqtype, long reqvalue)
